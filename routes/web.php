...
//放送中の番組を取得する
Route::get('/schedule', 'RadioProgramController@fetchProgramGuide')->name('program.schedule');
...
//放送局の週間番組表を取得する
Route::get('schedule/{station_id}', 'RadioBroadcastController@getBroadCastId')->name('schedule.weekly');
...
//レビューの投稿
Route::post('/review/{id}', 'PostController@store')->name('post.store');
